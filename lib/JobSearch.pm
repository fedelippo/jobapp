...
use JobSearch::Schema;

=head1 DESCRIPTION

This is the base JobSearch application.

It has the following routes available by default:

L<JobSearch::Controller::Index>
L<JobSearch::Controller::Public>
L<JobSearch::Controller::Admin>
L<JobSearch::Controller::Agency>
L<JobSearch::Controller::Candidates>
L<JobSearch::Controller::Job>
...
has _welcome => sub {
    ...
    return {
        welcome => 'Welcome to the JobSearch app',
    };
};
...
sub setup_routes {
    ...
    my $r = $self->routes->namespaces(['JobSearch::Controller']);
...
sub setup_db_handler{ return JobSearch::Schema->connect('dbi:SQLite:share/test.db','','', {sqlite_unicode=>1}) }
